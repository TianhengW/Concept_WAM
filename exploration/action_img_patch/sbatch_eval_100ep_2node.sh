...
cd "${REPO_ROOT}"
export LOGDIR="slurm_logs/eval_100ep_seed${SEED}"
export RESDIR="${REPO_ROOT}/evaluate_results/robotwin/eval_100ep_seed${SEED}"
mkdir -p "${LOGDIR}" "${RESDIR}"

D="${REPO_ROOT}/runs/robotwin_flux2_klein_4b_actionpatch_full/2026-08-11_14-38-46"
export CKPT="${D}/checkpoints/weights/step_104850.pt"
