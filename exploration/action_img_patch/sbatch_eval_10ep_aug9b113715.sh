#!/bin/bash
# 100ep dual-phase eval of aug-mixed run ckpt step_113715 (50 tasks x clean+random x 100ep).
...
#SBATCH -J eval_10ep_aug9b113715
...
echo "[launcher] aug9b113715 seed=${SEED} groups=$(echo ${GLIST} | wc -w) nodes=${SLURM_JOB_NODELIST}"
bash exploration/action_img_patch/eval_10ep_worker.sh
echo "[launcher] aug9b113715 seed=${SEED} COMPLETE"
