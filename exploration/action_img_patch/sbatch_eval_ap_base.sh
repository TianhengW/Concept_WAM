#!/usr/bin/env bash
# Eval ap_base (original ImageWAM MoT, 1/20-data run) final ckpt step_041940.
...
export EXP_PATH="${EXP_PATH:-${REPO_ROOT}/runs/robotwin_flux2_klein_4b_base_sub20/2026-08-07_10-04-27}"
