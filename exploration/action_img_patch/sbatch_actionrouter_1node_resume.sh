...
#SBATCH -x nv-h100-029,nv-h100-007,gnho020,gnho009,gnho017,gnho036,gnho011
#SBATCH -J ap_router_resume
...
RESUME_DIR="${REPO_ROOT}/runs/robotwin_flux2_klein_4b_actionrouter_sub20/2026-08-24_21-04-42/checkpoints/state/step_020000"
