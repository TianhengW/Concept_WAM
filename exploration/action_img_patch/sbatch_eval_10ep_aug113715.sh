...
cd "${REPO_ROOT}"
export LOGDIR="slurm_logs/eval_10ep_aug113715"
export RESDIR="${REPO_ROOT}/evaluate_results/robotwin/eval_10ep_aug113715"
...
echo "[launcher] aug113715 seed=${SEED} groups=$(echo ${GLIST} | wc -w) nodes=${SLURM_JOB_NODELIST}"
bash exploration/action_img_patch/eval_10ep_worker.sh
echo "[launcher] aug113715 seed=${SEED} COMPLETE"
