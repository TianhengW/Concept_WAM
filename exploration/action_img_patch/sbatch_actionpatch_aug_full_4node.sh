...
echo "[sbatch] action-as-patch aug 4node | nodes=${SLURM_JOB_NODELIST} master=${MASTER_ADDR}:${MASTER_PORT}"

# 32 GPUs x batch 4 x accum 2 = global 256. Data: full no-op-filtered + aug hard tasks.
