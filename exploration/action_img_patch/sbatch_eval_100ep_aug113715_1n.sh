...
cd "${REPO_ROOT}"
export LOGDIR="slurm_logs/eval_100ep_aug113715_seed${SEED}"
export RESDIR="${REPO_ROOT}/evaluate_results/robotwin/eval_100ep_aug113715_seed${SEED}"
