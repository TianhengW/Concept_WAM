...
CKPT="${D}/checkpoints/weights/step_110000.pt"; STATS="${D}/dataset_stats.json"
LOGDIR="slurm_logs/eval_100ep_aug110k_seed43"; RESDIR="${REPO_ROOT}/evaluate_results/robotwin/eval_100ep_aug110k_seed43"
