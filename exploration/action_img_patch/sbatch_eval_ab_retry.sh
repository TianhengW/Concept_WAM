...
#SBATCH -J eval_ab_retry
#SBATCH -o slurm_logs/%x_%j.out
#SBATCH -t 6:00:00
#SBATCH -x nv-h100-029,nv-h100-007,gnho006,gnho020,gnho041,gnho009,gnho033,gnho018,gnho032,gnho011
# Retest of timeout-zeroed eval units for the timealign/sigmashift study.
# 用法: TASK_CFG=<task config 名> EVAL_STEP=<0xxxxx> EXP_PATH=<run dir> \
#       UNITS_FILE=<每行 "task phase"> OUT_TAG=<输出子目录名> sbatch [-x ...] 本脚本
set -uo pipefail
